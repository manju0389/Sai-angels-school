...
/**
 * Fetch the Smc Certificate PDF details
 */
async function getSmcPDF() {
  const res = await fetch(
    `${apiUrl}/cbse-documents/pdf/smc`,
    {
      cache: "no-store",
    }
  );
    ...
    <main>
      ...
      <section className="w-full bg-gradient-to-r from-pink-300 via-purple-200 to-blue-300 py-10 px-6 mb-[4%]">
        <div className="mx-auto text-center space-y-10">
            <h1 className="text-4xl font-bold text-black-800 mb-3"> School Management Committee </h1>
        </div>
        </section>
